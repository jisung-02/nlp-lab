...
README는 프로젝트 소개입니다. 개발 절차는 [개발 환경과 명령어](docs/development.md), 운영 절차는 [운영 가이드](docs/operations.md), 구조 설명은 [구조와 유지보수 기준](docs/architecture.md)을 참고합니다.
...
## 4) 작업 원칙
1. 먼저 본 문서와 작업에 해당하는 `docs/` 문서를 읽고 범위를 확정한다.
